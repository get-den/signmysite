...
const ITEMS: Array<{ q: string; a: ReactNode }> = [
  {
    ...
    a: (
      <>
        ...
        old script is the most common cause. Then check the tag is exactly{" "}
        <code>{`<script src="${ORIGIN}/w/you.js"></script>`}</code> and
        sits just before the closing <code>&lt;/body&gt;</code> tag. Open the console
  ...
  },
  {
    ...
    a: (
      <>
        The widget couldn't reach the API. Check you're online and that{" "}
        <code>{HOST}</code> loads in a tab. Running locally? Make sure
  ...
  },
  {
    ...
    a: (
      <>
        Give it a second. The card refreshes after the sign-in popup closes. If it
        ...
        site), so finish the popup on this same site. Still stuck? Use{" "}
  ...
  },
  {
    ...
    a: (
      <>
        ...
        showing visitors the “create your account” card. Your permanent tag is what makes the
        widget <em>yours</em>.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        That's expected when the widget doesn't yet know you're signed in (a first visit, or
  ...
  },
  {
    ...
    a: (
      <>
        ...
        set your real site URL in <Link to="/edit">Edit profile</Link> (or reload the widget
        on the live site).
      </>
    ),
  },
...
export function Troubleshoot() {
  return (
    <div className="narrow">
      ...
      <p className="lead">
        Quick fixes for the signmysite widget. A hard refresh solves most issues.
      </p>
      ...
      <p className="lead">
        ...
        repo. Include your browser, the exact script tag, and any console errors.
      </p>
    </div>
  );
}
