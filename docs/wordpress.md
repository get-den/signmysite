...
1. Dashboard → **Appearance → Widgets** (or **Editor → Footer** on block themes).
2. Add a **Custom HTML** block to the Footer.
3. Paste the line. **Update**.

**Alternative:** install the free **WPCode** plugin → add a snippet → "Site Wide Footer".
