/*
 * The single source of truth for where Den is hosted.
 *
 * DEN_BASE_URL is the ONE knob that names our public origin. Set it in prod
 * (e.g. https://den.com); it defaults to http://localhost:$PORT in dev. Every
